        ...
        vec![
            ...
            ISCOptionDefinition {
                ...
                r#type: ISCOptionDefinitionType::Arrays(Box::new(
                    ISCOptionDefinitionType::IPAddress,
                )),
            },
            ISCOptionDefinition {
                code: 88,
            ...
            ISCOptionDefinition {
                ...
                r#type: ISCOptionDefinitionType::IPAddress,
            },
            ISCOptionDefinition {
                code: 138,
            ...
            ISCOptionDefinition {
                ...
                r#type: ISCOptionDefinitionType::Records(vec![
                    Box::new(ISCOptionDefinitionType::UInt8),
                    Box::new(ISCOptionDefinitionType::UInt8),
                    Box::new(ISCOptionDefinitionType::UInt8),
                ]),
            },
            ISCOptionDefinition {
                ...
                r#type: ISCOptionDefinitionType::Records(vec![
                    Box::new(ISCOptionDefinitionType::UInt8),
                    Box::new(ISCOptionDefinitionType::DataString),
                ]),
            },
            ISCOptionDefinition {
                code: 212,
                ...
                r#type: ISCOptionDefinitionType::Records(vec![
                    Box::new(ISCOptionDefinitionType::UInt8),
                    Box::new(ISCOptionDefinitionType::UInt8),
                    Box::new(ISCOptionDefinitionType::IPv6Address),
                    Box::new(ISCOptionDefinitionType::Arrays(Box::new(
                        ISCOptionDefinitionType::IPAddress,
                    ))),
                ]),
            },
            ...
            ISCOptionDefinition {
                ...
                r#type: ISCOptionDefinitionType::Records(vec![
                    Box::new(ISCOptionDefinitionType::UInt8),
                    Box::new(ISCOptionDefinitionType::IPAddress),
                    Box::new(ISCOptionDefinitionType::IPAddress),
                    Box::new(ISCOptionDefinitionType::Text),
                ]),
            },
            ISCOptionDefinition {
                code: 11,
            ...
            ISCOptionDefinition {
                ...
                r#type: ISCOptionDefinitionType::Records(vec![
                    Box::new(ISCOptionDefinitionType::Boolean),
                    Box::new(ISCOptionDefinitionType::Arrays(Box::new(
                        ISCOptionDefinitionType::IPAddress,
                    ))),
                ]),
